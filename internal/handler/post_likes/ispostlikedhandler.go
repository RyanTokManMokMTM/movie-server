...
func IsPostLikedHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IsPostLikedReq
		...
		l := post_likes.NewIsPostLikedLogic(r.Context(), svcCtx)
		resp, err := l.IsPostLiked(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
