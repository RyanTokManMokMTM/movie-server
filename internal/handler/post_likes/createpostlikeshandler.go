...
func CreatePostLikesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreatePostLikesReq
		...
		l := post_likes.NewCreatePostLikesLogic(r.Context(), svcCtx)
		resp, err := l.CreatePostLikes(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
