...
func RemovePostLikesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemovePostLikesReq
		...
		l := post_likes.NewRemovePostLikesLogic(r.Context(), svcCtx)
		resp, err := l.RemovePostLikes(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
