...
func UpdateIsReadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetIsReadReq
		...
		l := room.NewUpdateIsReadLogic(r.Context(), svcCtx)
		resp, err := l.UpdateIsRead(&req)
