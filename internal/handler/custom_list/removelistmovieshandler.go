...
func RemoveListMoviesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemoveListMoviesReq
		...
		l := custom_list.NewRemoveListMoviesLogic(r.Context(), svcCtx)
		resp, err := l.RemoveListMovies(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
