...
func CountCollectedMovieHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CountCollectedMovieReq
		...
		l := custom_list.NewCountCollectedMovieLogic(r.Context(), svcCtx)
		resp, err := l.CountCollectedMovie(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
