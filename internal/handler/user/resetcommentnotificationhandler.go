...
func ResetCommentNotificationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommentNotificationReq
		...
		l := user.NewResetCommentNotificationLogic(r.Context(), svcCtx)
		resp, err := l.ResetCommentNotification(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
