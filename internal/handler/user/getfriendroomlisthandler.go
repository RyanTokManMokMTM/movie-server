...
func GetFriendRoomListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetUserFriendRoomListReq
		...
		l := user.NewGetFriendRoomListLogic(r.Context(), svcCtx)
		resp, err := l.GetFriendRoomList(&req)
