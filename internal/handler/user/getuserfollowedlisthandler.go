...
func GetUserFollowedListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFollowedListReq
		...
		l := user.NewGetUserFollowedListLogic(r.Context(), svcCtx)
		resp, err := l.GetUserFollowedList(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
