...
import (
	...
	"github.com/ryantokmanmokmtm/movie-server/internal/logic/notification"
	"github.com/ryantokmanmokmtm/movie-server/internal/svc"
	"github.com/ryantokmanmokmtm/movie-server/internal/types"
)

func GetlikenotificationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetLikeNotificationReq
		...
		l := notification.NewGetlikenotificationLogic(r.Context(), svcCtx)
		resp, err := l.Getlikenotification(&req)
