...
func GetUserGenreHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetUserGenreReq
		...
		l := user_genre.NewGetUserGenreLogic(r.Context(), svcCtx)
		resp, err := l.GetUserGenre(&req)
