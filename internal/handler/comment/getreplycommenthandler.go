...
import (
	...
	"github.com/ryantokmanmokmtm/movie-server/internal/logic/comment"
	"github.com/ryantokmanmokmtm/movie-server/internal/svc"
	"github.com/ryantokmanmokmtm/movie-server/internal/types"
)

func GetReplyCommentHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetReplyCommentReq
		...
		l := comment.NewGetReplyCommentLogic(r.Context(), svcCtx)
		resp, err := l.GetReplyComment(&req)
