...
func CreateCommentLikesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateCommentLikesReq
		...
		l := comment_likes.NewCreateCommentLikesLogic(r.Context(), svcCtx)
		resp, err := l.CreateCommentLikes(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
