...
func RemoveCommentLikesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemoveCommentLikesReq
		...
		l := comment_likes.NewRemoveCommentLikesLogic(r.Context(), svcCtx)
		resp, err := l.RemoveCommentLikes(&req)
