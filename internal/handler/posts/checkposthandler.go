...
func CheckPostHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CheckPostReq
		...
		l := posts.NewCheckPostLogic(r.Context(), svcCtx)
		resp, err := l.CheckPost(&req)
