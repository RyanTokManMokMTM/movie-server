...
func CountAllUserPostHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CountUserPostsReq
		...
		l := posts.NewCountAllUserPostLogic(r.Context(), svcCtx)
		resp, err := l.CountAllUserPost(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
