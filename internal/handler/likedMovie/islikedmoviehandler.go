...
func IsLikedMovieHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IsLikedMovieReq
		...
		l := likedMovie.NewIsLikedMovieLogic(r.Context(), svcCtx)
		resp, err := l.IsLikedMovie(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
