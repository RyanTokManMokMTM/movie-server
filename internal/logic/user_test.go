...
//
//			test.MockTest(daoMock)
//			r, err := http.NewRequest("POST", uri, bytes.NewBuffer(test.Data))
//			r.Header.Set("Content-Type", "application/json; charset=UTF-8")
//			assert.Nil(t, err)
//
//			w := httptest.NewRecorder()
...
//			assert.Nil(t, err)
//
//			r, err := http.NewRequest("PATCH", uri, bytes.NewBuffer(test.Data))
//			assert.Nil(t, err)
//
...
//			r, err := http.NewRequest("GET", uri, emptyBuffer) //for read data  and write to response
//			assert.Nil(t, err)
//
//			r.Header.Add("Authorization", "Bearer "+token)
//
...
//			assert.Nil(t, err)
//
//			r, err := http.NewRequest("PATCH", uri, body)
//			assert.Nil(t, err)
//			r.Header.Add("Authorization", "Bearer "+token)
